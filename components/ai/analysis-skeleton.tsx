const steps = ["Reading your ride data...", "Extracting key signals...", "Building recommendation...", "Finalizing report..."];

export function AnalysisSkeleton() {
  return (
    <div className="cc-card space-y-4 p-4">
      <div className="space-y-3 rounded-2xl border border-orange-100 bg-orange-50/60 p-4">
        ...
        <div className="h-7 w-4/5 animate-pulse rounded-xl bg-orange-100" />
